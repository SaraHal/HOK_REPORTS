...
!function (t, e) {
  ...
  function i(t, e) {
      ...
      var t = !0,
        ...
        var i = m(this._element).find(S)[0];if (i) {
          if ("radio" === i.type) if (i.checked && m(this._element).hasClass(C)) t = !1;else {
            var s = m(n).find(w)[0];s && m(s).removeClass(C);
          }if (t) {
    ...
    var e = "carousel",
      ...
      function o(e, n) {
        ...
        var i,
            ...
            C = Boolean(this._interval);if (e === h ? (i = v, s = E, r = u) : (i = p, s = T, r = f), c && t(c).hasClass(g)) this._isSliding = !1;else if (!this._triggerSlideEvent(c, r).isDefaultPrevented() && a && c) {
          this._isSliding = !0, C && this.pause(), this._setActiveIndicatorElement(c);var I = t.Event(d.SLID, { relatedTarget: c, direction: r, from: l, to: _ });P.supportsTransitionEnd() && t(this._element).hasClass(m) ? (t(c).addClass(s), P.reflow(c), t(a).addClass(i), t(c).addClass(i), t(a).one(P.TRANSITION_END, function () {
    ...
    var e = "collapse",
        ...
        p = function () {
      function i(e, n) {
        this._isTransitioning = !1, this._element = e, this._config = this._getConfig(n), this._triggerArray = t.makeArray(t('[data-toggle="collapse"][href="#' + e.id + '"],[data-toggle="collapse"][data-target="#' + e.id + '"]'));for (var i = t(m.DATA_TOGGLE), s = 0; s < i.length; s++) {
          var r = i[s],
        ...
        var e,
            s,
            r = this;if (!this._isTransitioning && !t(this._element).hasClass(c) && (this._parent && 0 === (e = t.makeArray(t(this._parent).find(m.ACTIVES).filter('[data-parent="' + this._config.parent + '"]'))).length && (e = null), !(e && (s = t(e).not(this._selector).data(n)) && s._isTransitioning))) {
      ...
      "A" === e.currentTarget.tagName && e.preventDefault();var i = t(this),
        ...
        var e = t(this),
            s = e.data(n) ? "toggle" : i.data();p._jQueryInterface.call(e, s);
      });
    ...
    var e,
      ...
      function e(t, e) {
      ...
      }var l = e.prototype;return l.toggle = function () {
        if (!this._element.disabled && !t(this._element).hasClass(d)) {
          var i = e._getParentFromElement(this._element),
              s = t(this._menu).hasClass(_);if (e._clearMenus(), !s) {
            var r = { relatedTarget: this._element },
                o = t.Event(f.SHOW, r);if (t(i).trigger(o), !o.isDefaultPrevented()) {
              if (!this._inNavbar) {
                if ("undefined" == typeof n) throw new TypeError("Bootstrap dropdown require Popper.js (https://popper.js.org)");var a = this._element;t(i).hasClass(g) && (t(this._menu).hasClass(E) || t(this._menu).hasClass(v)) && (a = i), "scrollParent" !== this._config.boundary && t(i).addClass(T), this._popper = new n(a, this._menu, this._getPopperConfig());
              }"ontouchstart" in document.documentElement && 0 === t(i).closest(A).length && t("body").children().on("mouseover", null, t.noop), this._element.focus(), this._element.setAttribute("aria-expanded", !0), t(this._menu).toggleClass(_), t(i).toggleClass(_).trigger(t.Event(f.SHOWN, r));
            }
          }
        }
      }, l.dispose = function () {
        t.removeData(this._element, o), t(this._element).off(a), this._element = null, this._menu = null, null !== this._popper && (this._popper.destroy(), this._popper = null);
      }, l.update = function () {
        this._inNavbar = this._detectNavbar(), null !== this._popper && this._popper.scheduleUpdate();
      }, l._addEventListeners = function () {
        var e = this;t(this._element).on(f.CLICK, function (t) {
          t.preventDefault(), t.stopPropagation(), e.toggle();
        });
      }, l._getConfig = function (e) {
        return e = r({}, this.constructor.Default, t(this._element).data(), e), P.typeCheckConfig(i, e, this.constructor.DefaultType), e;
      }, l._getMenuElement = function () {
        if (!this._menu) {
          var n = e._getParentFromElement(this._element);this._menu = t(n).find(I)[0];
        }return this._menu;
      }, l._getPlacement = function () {
        var e = t(this._element).parent(),
            n = b.BOTTOM;return e.hasClass(g) ? (n = b.TOP, t(this._menu).hasClass(v) && (n = b.TOPEND)) : e.hasClass(m) ? n = b.RIGHT : e.hasClass(p) ? n = b.LEFT : t(this._menu).hasClass(v) && (n = b.BOTTOMEND), n;
        ...
        return this.each(function () {
          var i = t(this).data(o);if (i || (i = new e(this, "object" == (typeof n === "undefined" ? "undefined" : _typeof(n)) ? n : null), t(this).data(o, i)), "string" == typeof n) {
            if ("undefined" == typeof i[n]) throw new TypeError('No method named "' + n + '"');i[n]();
          }
        });
      }, e._clearMenus = function (n) {
        if (!n || 3 !== n.which && ("keyup" !== n.type || 9 === n.which)) for (var i = t.makeArray(t(y)), s = 0; s < i.length; s++) {
          var r = e._getParentFromElement(i[s]),
              a = t(i[s]).data(o),
              l = { relatedTarget: i[s] };if (a) {
            var h = a._menu;if (t(r).hasClass(_) && !(n && ("click" === n.type && /input|textarea/i.test(n.target.tagName) || "keyup" === n.type && 9 === n.which) && t.contains(r, n.target))) {
              var c = t.Event(f.HIDE, l);t(r).trigger(c), c.isDefaultPrevented() || ("ontouchstart" in document.documentElement && t("body").children().off("mouseover", null, t.noop), i[s].setAttribute("aria-expanded", "false"), t(h).removeClass(_), t(r).removeClass(_).trigger(t.Event(f.HIDDEN, l)));
            }
          }
        }
        ...
        if ((/input|textarea/i.test(n.target.tagName) ? !(32 === n.which || 27 !== n.which && (40 !== n.which && 38 !== n.which || t(n.target).closest(I).length)) : c.test(n.which)) && (n.preventDefault(), n.stopPropagation(), !this.disabled && !t(this).hasClass(d))) {
          var i = e._getParentFromElement(this),
              s = t(i).hasClass(_);if ((s || 27 === n.which && 32 === n.which) && (!s || 27 !== n.which && 32 !== n.which)) {
            var r = t(i).find(D).get();if (0 !== r.length) {
              var o = r.indexOf(n.target);38 === n.which && o > 0 && o--, 40 === n.which && o < r.length - 1 && o++, o < 0 && (o = 0), r[o].focus();
            }
          } else {
            if (27 === n.which) {
              var a = t(i).find(y)[0];t(a).trigger("focus");
    ...
    }();return t(document).on(f.KEYDOWN_DATA_API, y, N._dataApiKeydownHandler).on(f.KEYDOWN_DATA_API, I, N._dataApiKeydownHandler).on(f.CLICK_DATA_API + " " + f.KEYUP_DATA_API, N._clearMenus).on(f.CLICK_DATA_API, y, function (e) {
      e.preventDefault(), e.stopPropagation(), N._jQueryInterface.call(t(this), "toggle");
    }).on(f.CLICK_DATA_API, C, function (t) {
      t.stopPropagation();
    }), t.fn[i] = N._jQueryInterface, t.fn[i].Constructor = N, t.fn[i].noConflict = function () {
    ...
    var e = "modal",
      ...
      }var m = o.prototype;return m.toggle = function (t) {
    ...
    var e,
      ...
      function e(t, e) {
      ...
      }var l = e.prototype;return l.enable = function () {
        this._isEnabled = !0;
      }, l.disable = function () {
        this._isEnabled = !1;
        ...
        if (this._isEnabled) if (e) {
          ...
          if (t(this.getTipElement()).hasClass(v)) return void this._leave(null, this);this._enter(null, this);
        }
      }, l.dispose = function () {
        clearTimeout(this._timeout), t.removeData(this.element, this.constructor.DATA_KEY), t(this.element).off(this.constructor.EVENT_KEY), t(this.element).closest(".modal").off("hide.bs.modal"), this.tip && t(this.tip).remove(), this._isEnabled = null, this._timeout = null, this._hoverState = null, this._activeTrigger = null, null !== this._popper && this._popper.destroy(), this._popper = null, this.element = null, this.config = null, this.tip = null;
      }, l.show = function () {
        var i = this;if ("none" === t(this.element).css("display")) throw new Error("Please use show on visible elements");var s = t.Event(this.constructor.Event.SHOW);if (this.isWithContent() && this._isEnabled) {
          t(this.element).trigger(s);var r = t.contains(this.element.ownerDocument.documentElement, this.element);if (s.isDefaultPrevented() || !r) return;var o = this.getTipElement(),
              a = P.getUID(this.constructor.NAME);o.setAttribute("id", a), this.element.setAttribute("aria-describedby", a), this.setContent(), this.config.animation && t(o).addClass(p);var l = "function" == typeof this.config.placement ? this.config.placement.call(this, o, this.element) : this.config.placement,
              h = this._getAttachment(l);this.addAttachmentClass(h);var c = !1 === this.config.container ? document.body : t(this.config.container);t(o).data(this.constructor.DATA_KEY, this), t.contains(this.element.ownerDocument.documentElement, this.tip) || t(o).appendTo(c), t(this.element).trigger(this.constructor.Event.INSERTED), this._popper = new n(this.element, o, { placement: h, modifiers: { offset: { offset: this.config.offset }, flip: { behavior: this.config.fallbackPlacement }, arrow: { element: T }, preventOverflow: { boundariesElement: this.config.boundary } }, onCreate: function onCreate(t) {
              t.originalPlacement !== t.placement && i._handlePopperPlacementChange(t);
            }, onUpdate: function onUpdate(t) {
              i._handlePopperPlacementChange(t);
            } }), t(o).addClass(v), "ontouchstart" in document.documentElement && t("body").children().on("mouseover", null, t.noop);var u = function u() {
            i.config.animation && i._fixTransition();var e = i._hoverState;i._hoverState = null, t(i.element).trigger(i.constructor.Event.SHOWN), e === g && i._leave(null, i);
          };P.supportsTransitionEnd() && t(this.tip).hasClass(p) ? t(this.tip).one(P.TRANSITION_END, u).emulateTransitionEnd(e._TRANSITION_DURATION) : u();
        }
      }, l.hide = function (e) {
        var n = this,
            ...
            r = function r() {
          n._hoverState !== _ && i.parentNode && i.parentNode.removeChild(i), n._cleanTipClass(), n.element.removeAttribute("aria-describedby"), t(n.element).trigger(n.constructor.Event.HIDDEN), null !== n._popper && n._popper.destroy(), e && e();
        };t(this.element).trigger(s), s.isDefaultPrevented() || (t(i).removeClass(v), "ontouchstart" in document.documentElement && t("body").children().off("mouseover", null, t.noop), this._activeTrigger[I] = !1, this._activeTrigger[C] = !1, this._activeTrigger[y] = !1, P.supportsTransitionEnd() && t(this.tip).hasClass(p) ? t(i).one(P.TRANSITION_END, r).emulateTransitionEnd(150) : r(), this._hoverState = "");
      }, l.update = function () {
        ...
        var e = t(this.getTipElement());this.setElementContent(e.find(E), this.getTitle()), e.removeClass(p + " " + v);
        ...
        var e = this;this.config.trigger.split(" ").forEach(function (n) {
          if ("click" === n) t(e.element).on(e.constructor.Event.CLICK, e.config.selector, function (t) {
            ...
            var i = n === y ? e.constructor.Event.MOUSEENTER : e.constructor.Event.FOCUSIN,
                s = n === y ? e.constructor.Event.MOUSELEAVE : e.constructor.Event.FOCUSOUT;t(e.element).on(i, e.config.selector, function (t) {
              return e._enter(t);
        ...
        return "number" == typeof (e = r({}, this.constructor.Default, t(this.element).data(), e)).delay && (e.delay = { show: e.delay, hide: e.delay }), "number" == typeof e.title && (e.title = e.title.toString()), "number" == typeof e.content && (e.content = e.content.toString()), P.typeCheckConfig(i, e, this.constructor.DefaultType), e;
        ...
        return this.each(function () {
          var i = t(this).data(o),
              s = "object" == (typeof n === "undefined" ? "undefined" : _typeof(n)) && n;if ((i || !/dispose|hide/.test(n)) && (i || (i = new e(this, s), t(this).data(o, i)), "string" == typeof n)) {
            if ("undefined" == typeof i[n]) throw new TypeError('No method named "' + n + '"');i[n]();
          }
        });
      }, s(e, null, [{ key: "VERSION", get: function get() {
    ...
    }();return t.fn[i] = D._jQueryInterface, t.fn[i].Constructor = D, t.fn[i].noConflict = function () {
    ...
    var e = "popover",
      ...
      var o, g;function m() {
      ...
      }g = r, (o = m).prototype = Object.create(g.prototype), o.prototype.constructor = o, o.__proto__ = g;var p = m.prototype;return p.isWithContent = function () {
        ...
        return this.each(function () {
          var i = t(this).data(n),
              s = "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) ? e : null;if ((i || !/destroy|hide/.test(e)) && (i || (i = new m(this, s), t(this).data(n, i)), "string" == typeof e)) {
            if ("undefined" == typeof i[e]) throw new TypeError('No method named "' + e + '"');i[e]();
          }
        });
      }, s(m, null, [{ key: "VERSION", get: function get() {
          return "4.0.0";
        } }, { key: "Default", get: function get() {
          return l;
        } }, { key: "NAME", get: function get() {
    ...
    var e = "bs.tab",
      ...
      function n(t) {
        ...
        if (n) {
          t(n).removeClass(c + " " + a);var s = t(n.parentNode).find(p)[0];s && t(s).removeClass(a), "tab" === n.getAttribute("role") && n.setAttribute("aria-selected", !1);
        }if (t(e).addClass(a), "tab" === e.getAttribute("role") && e.setAttribute("aria-selected", !0), P.reflow(e), t(e).addClass(c), e.parentNode && t(e.parentNode).hasClass(o)) {
          var r = t(e).closest(u)[0];r && t(r).find(m).addClass(a), e.setAttribute("aria-expanded", !0);
        }i && i();
  ...
  }(e), t.Util = P, t.Alert = L, t.Button = R, t.Carousel = j, t.Collapse = H, t.Dropdown = M, t.Modal = W, t.Popover = x, t.Scrollspy = K, t.Tab = B, t.Tooltip = U, Object.defineProperty(t, "__esModule", { value: !0 });
});
